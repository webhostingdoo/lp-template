  ...
  return (
    <section id="our-facilities" className="bg-primary py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="flex gap-6 overflow-x-auto pb-4 snap-x snap-mandatory md:grid md:grid-cols-3 lg:grid-cols-4 md:overflow-visible md:pb-0">
          {config.facilities.items.map((card) => (
            <div
              key={card.name}
