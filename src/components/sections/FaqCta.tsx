  ...
  return (
    <section className="py-20 md:py-28" style={{ backgroundColor: "#0e2a47" }}>
      <div className="max-w-7xl mx-auto px-4 md:px-8 text-center">
        ...
        <hr className="border-t-2 border-accent w-16 mx-auto mt-6 mb-8" />
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-10">
          ...
          >
            ...
            <br />
            <span className="text-xl font-bold">{config.brand.phone}</span>
          </a>
          <a
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-8 text-accent text-sm uppercase tracking-widest font-semibold">
