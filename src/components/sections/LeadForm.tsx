  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto px-4 md:px-8">
        ...
        <hr className="border-t-2 border-accent w-20 mx-auto mb-6" />
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div>
              ...
              <input type="text" id="first_name" name="first_name" maxLength={40} placeholder="First Name"
                className="w-full px-4 py-3 rounded bg-white/10 border border-white/20 text-white placeholder-white/40 focus:outline-none focus:border-accent transition" />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea id="00NDn00000brftN" name="00NDn00000brftN" rows={4} maxLength={220} placeholder="Additional Comments"
              className="w-full px-4 py-3 rounded bg-white/10 border border-white/20 text-white placeholder-white/40 focus:outline-none focus:border-accent transition resize-none" />
          </div>
